  ...
  return (
    <>
      ...
      {/* <div className="container">
        <h1 style={{ color: "white", textAlign: "center", fontSize: "36px"}}> Welcome to I Wear Whatevr, an online clothing manager</h1>
      </div> */}
      <div className="parent" style={{ width: "100%", height: "500px" }}>
        <div className="whatevr" style={{ boxShadow: "0 0 10px rgba(0, 0, 0, 0.3)", padding: "20px", borderRadius: "5px", border: "inset", borderColor: "#ffe978"  }}>
          ...
          <p style={{ textShadow: "0 0 5px #000"}}>Use our weather tracker to style the perfect outfit!</p>
          <li>
            <Link to="/planner" className="nav-links-mobile">
              <a className="btn btn primary" title="Plan an Outfit">
                Plan an outfit!
              </a>
            </Link>
          </li>
      ...
      <div className="parent" style={{ width: "100%", height: "500px", }}>
        <div className="whatevr" style={{ border: "inset", borderColor: "#ffe978", boxShadow: "0 0 10px rgba(0, 0, 0, 0.3)", padding: "20px", borderRadius: "5px" }} >
          ...
          <p style={{ textShadow: "0 0 5px #000"}}>your closet in the palm of your hands</p>
          <li>
            <Link to='/closet'className= 'nav-links-mobile' >
              <a className="btn btn primary" title= "Checkout your clothes!">Checkout your clothes!</a>
            </Link>
          </li>
        </div>
      </div>
